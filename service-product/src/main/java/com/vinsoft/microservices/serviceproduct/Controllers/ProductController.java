package com.vinsoft.microservices.serviceproduct.Controllers;
...
public class ProductController {
    ...
    public ResponseEntity<List<Product>> listProduct(@RequestParam(name = "categoryId", required = false) Long categoryId) {
        System.out.println("dasdasdaa4545454");
        logger.info("dklsakdlklsa");
    ...
    @GetMapping(value = "/{id}")
    public ResponseEntity<Product> getProducto(@PathVariable("id") Long id) {
